...
from pyhanko.sign import signers, PdfSignatureMetadata, fields, timestamps, PdfSigner
...
class BulkSigner:
    ...
    def sign_one(
        ...
        with open(input_pdf_path, 'rb') as f:
            ...
            fields.append_signature_field(w, sig_field_spec=SigFieldSpec(
